---
name: airbnb-prices
description: "Get a real Airbnb price quote for a listing and dates, and compare that property across booking platforms for the cheapest rate. Use for \"how much is this Airbnb place\" or \"is it cheaper elsewhere\". Powered by ScoutingAPI."
version: "1.0.0"
license: MIT-0
author: ScoutingAPI
homepage: https://scoutingapi.com
repository: https://github.com/scoutingapi/airbnb-skills
user-invocable: true
...
tags: ["airbnb", "airbnb-api", "price", "price-comparison", "cross-ota", "travel", "accommodation"]
metadata: {"openclaw":{"emoji":"💲","requires":{"env":["SCOUTINGAPI_KEY"]},"primaryEnv":"SCOUTINGAPI_KEY","homepage":"https://scoutingapi.com"},"hermes":{"tags":["airbnb","airbnb-api","price","price-comparison","cross-ota","travel","accommodation"],"category":"travel"}}
---

# Airbnb prices & cross-OTA comparison

Get a real Airbnb price quote — and, because ScoutingAPI is cross-platform, compare the same property across OTAs for the cheapest rate with a computed min and median.
...
- "How much is this Airbnb listing for these dates?"
- "Is this Airbnb place cheaper on another site?"
...
ScoutingAPI is **cross-platform**: Airbnb data comes back in the *same unified schema* as Airbnb, Booking.com, Vrbo and Google Hotels, and the price-compare tool returns a computed **min** and **median** across every OTA — something a single-platform wrapper can't do.
...
ScoutingAPI is an independent service and is not affiliated with, endorsed by, or sponsored by Airbnb. Airbnb is a trademark of its respective owner.
