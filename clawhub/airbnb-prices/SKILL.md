---
name: airbnb-prices
description: "Get a real Airbnb price quote for a listing and dates, and compare that property across booking platforms for the cheapest rate. Use for \"how much is this Airbnb place\" or \"is it cheaper elsewhere\". Powered by StayingAPI."
version: "1.0.0"
license: MIT-0
author: StayingAPI
...
metadata: {"openclaw":{"emoji":"💲","requires":{"env":["STAYINGAPI_KEY"]},"primaryEnv":"STAYINGAPI_KEY","homepage":"https://stayingapi.com"},"hermes":{"tags":["airbnb","airbnb-api","price","price-comparison","cross-ota","travel","accommodation"],"category":"travel"}}
---

# Airbnb prices & cross-OTA comparison

Get a real Airbnb price quote — and, because StayingAPI is cross-platform, compare the same property across OTAs for the cheapest rate with a computed min and median.
