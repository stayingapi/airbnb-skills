---
name: airbnb-full
description: "Complete Airbnb toolkit — search, availability, listing detail, price, cross-OTA price comparison and reviews, all in one unified schema. Install this when an agent needs broad Airbnb coverage. Powered by ScoutingAPI."
version: "1.0.0"
license: MIT-0
author: ScoutingAPI
...
metadata: {"openclaw":{"emoji":"🧰","requires":{"env":["SCOUTINGAPI_KEY"]},"primaryEnv":"SCOUTINGAPI_KEY","homepage":"https://scoutingapi.com"},"hermes":{"tags":["airbnb","airbnb-api","search","availability","reviews","price-comparison","travel","accommodation"],"category":"travel"}}
---
