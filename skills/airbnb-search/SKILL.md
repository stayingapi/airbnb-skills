---
name: airbnb-search
description: "Search live Airbnb stays by location, dates and occupancy, returned in one unified schema alongside every other booking platform. Use when a user wants to find Airbnb listings. Powered by the ScoutingAPI REST API / MCP server."
version: "1.0.0"
license: MIT-0
author: ScoutingAPI
...
tags: ["airbnb", "airbnb-api", "search", "vacation-rental", "travel", "accommodation"]
metadata: {"openclaw":{"emoji":"🔍","requires":{"env":["SCOUTINGAPI_KEY"]},"primaryEnv":"SCOUTINGAPI_KEY","homepage":"https://scoutingapi.com"},"hermes":{"tags":["airbnb","airbnb-api","search","vacation-rental","travel","accommodation"],"category":"travel"}}
---

# Airbnb search

Search live Airbnb stays via [ScoutingAPI](https://scoutingapi.com) — one call, the same unified schema you use for Airbnb, Booking.com, Vrbo and Google Hotels.
...
- "Find Airbnb places in Split, HR for mid-July"
- "Search Airbnb for a 2-bed under a budget"
